...
type ProductsReturnProduct struct {
	...
	EconomicOperators                  ProductsReturnEconomicOperators           `xml:"EconomicOperators"`
}
...
type ProductsReturnEconomicOperators struct {
	XmlName          xml.Name                         `xml:"EconomicOperators"`
